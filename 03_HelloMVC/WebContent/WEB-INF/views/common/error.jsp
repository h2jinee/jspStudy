...
<%
	//http status error code로 에러페이지에 오게되면 exception객체는 null이다.
	int statusCode = response.getStatus();
	//System.out.println("statusCode@error.jsp="+statusCode);
	
	//예외가 던져지거나 httpStatusCode값으로 넘어온 경우
	//모두를 처리하는 메세지 변수 : exception객체의 null여부를 판단한다.
...
<body>
	...
	<a href="<%=request.getContextPath()%>">
		<img src="<%=request.getContextPath() %>/images/home.png" width="30px" alt="" />
	</a>
</body>
</html>