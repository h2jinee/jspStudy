...
<%
	...
	if(m.getHobby() != null){ 
		String[] hobbies = m.getHobby().split(","); //["운동","독서","등산","게임","여행"]
	...
	$("[name=delFrm]").submit();
        ...
        <table>
			<tr>
				<th>아이디</th>
				<td>
					<input type="text" placeholder="4글자이상" name="memberId" id="memberId_" value="<%=m.getMemberId()%>" required readonly>
				</td>
			</tr>
			<tr>
			<%-- 
			...
			<tr>
				<th>성별 </th>
				<td>
					<input type="radio" name="gender" id="gender0" value="M" <%="M".equals(m.getGender())?"checked":"" %>>
					<label for="gender0">남</label>
					<input type="radio" name="gender" id="gender1" value="F" <%="F".equals(m.getGender())?"checked":"" %>>
